...
INSERT INTO BUSINESS VALUES('business1', 'password', 'bname', 'address');

INSERT INTO USERS VALUES('business2', '#B');
INSERT INTO BUSINESS VALUES('business2', 'password', 'bname', 'address');

INSERT INTO USERS VALUES('business2', '#B');
INSERT INTO BUSINESS VALUES('business2', 'password', 'bname', 'address');

INSERT INTO USERS VALUES('business3', '#B');
INSERT INTO BUSINESS VALUES('business3', 'password', 'bname', 'address');

INSERT INTO USERS VALUES('business4', '#B');
INSERT INTO BUSINESS VALUES('business4', 'password', 'bname', 'address');

INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person1', 'fname lname', 'business1', 'address',TIMESTAMP('2021-04-02 10:35:12'),TIMESTAMP('2021-04-02 11:35:12') );
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person2', 'fname lname', 'business3', 'address',TIMESTAMP('2021-04-02 10:30:12'),TIMESTAMP('2021-04-02 14:35:12'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person3', 'fname lname', 'business2', 'address',TIMESTAMP('2021-04-02 11:20:12'),TIMESTAMP('2021-04-02 12:00:12'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person3', 'fname lname', 'business4', 'address',TIMESTAMP('2021-04-02 15:35:12'),TIMESTAMP('2021-04-02 15:45:12'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person6', 'fname lname', 'business4', 'address',TIMESTAMP('2021-04-02 18:35:12'),TIMESTAMP('2021-04-02 18:55:10'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person4', 'fname lname', 'business3', 'address',TIMESTAMP('2021-04-02 18:45:12'),TIMESTAMP('2021-04-02 18:55:01'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person6', 'fname lname', 'business4', 'address',TIMESTAMP('2021-04-02 18:51:13'),TIMESTAMP('2021-04-02 18:56:32'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person5', 'fname lname', 'business1', 'address',TIMESTAMP('2021-04-02 18:53:01'),TIMESTAMP('2021-04-02 18:59:14'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person9', 'fname lname', 'business1', 'address',TIMESTAMP('2021-04-02 19:05:12'),TIMESTAMP('2021-04-02 19:35:12'));
INSERT INTO CHECKIN (p_username, name, b_username, address, check_in, check_out)
VALUES('person8', 'fname lname', 'business2', 'address',TIMESTAMP('2021-04-02 19:45:10'),TIMESTAMP('2021-04-02 20:40:11'));
